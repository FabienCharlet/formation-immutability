package com.github.fabiencharlet.formation.immutability.slides.immutablefailfast;
...
public final class Person {
	...
	public Person addMail(String mail) {
		...
		if (Strings.isNullOrEmpty(mail)) {
			throw new InvalidParameterException("Mail is empty");
		}

		final List<String> newMails = new ArrayList<>(mails);
		newMails.add(mail);
